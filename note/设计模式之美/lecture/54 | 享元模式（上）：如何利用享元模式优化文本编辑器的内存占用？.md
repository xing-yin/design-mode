...
今天，我们再来学习一个不那么常用的模式，**享元模式（Flyweight Design Pattern）**。这也是我们要学习的最后一个结构型模式。
...
在享元模式的实现中，我们**通过工厂类来“缓存”已经创建好的对象。这里的“缓存”实际上是“存储”的意思**，跟我们平时所说的“数据库缓存”“CPU 缓存”“MemCache 缓存”是两回事。我们**平时所讲的缓存，主要是为了提高访问效率，而非复用**。
